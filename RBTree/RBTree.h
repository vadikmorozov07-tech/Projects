...
private:
    ...
    // рекурсивно удаляет всё поддерево, где node - корень
    ...
    // отсоединить endNode
    Node* detachEndNode(); 
    // присоединить endNode
    void attachEndNode(Node* endNode); 
    // рекурсивное вычисление высоты поддерева, где node - корень
